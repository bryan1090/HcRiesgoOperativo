...
@ManagedBean
@ViewScoped
public class ControladorCrudRoAccion {
	@EJB
	...
	public static final String nombrePagina = "/paginas/CrudAccion.jsf";
	...
	public ControladorCrudRoAccion() {
		sisUsuario = new SisUsuario();
		detalleEventoSeleccionadoLista = new ArrayList<RoDetalleEvento>();
		padresEvento = new ArrayList<String>();
		padresNegocio = new ArrayList<String>();
		roResponsablesTodos = new ArrayList<RoResponsable>();
		roDetalleEventoVista = new RoDetalleEvento();
		accionesTodos = new ArrayList<RoAccion>();
		roArchivoDetalleAccionVista = new RoArchivoDetalleAccion();

		cumplimientosTodos = new ArrayList<RoCumplimiento>();
		roAccionVista = new RoAccion();
		roAccionControlador = new RoAccion();
	...
	public void PostControladorCrudRoAccion() {
		...
		try {
			this.detalleEventoSeleccionadoLista
					.add((RoDetalleEvento) this.servicioRoDetalleEvento
							.buscarPorId(Integer.valueOf(this.dataManagerSesion
									.getIdDetalleSeleccionado())));
			this.roDetalleEventoVista = ((RoDetalleEvento) this.servicioRoDetalleEvento
					.buscarPorId(Integer.valueOf(this.dataManagerSesion
							.getIdDetalleSeleccionado())));
	...
	public void nuevoAccion() {
		...
		pnlAccion = true;
		mostrarPnlDetalleAccion = false;
		pnlEditarDetalleAccion = false;

		btnAnadirAccion = true;
		btnAnadirDetalleAccion = true;
		...
		this.roAccionVista.setNumeroOcurrenciasAcci(this.dataManagerSesion
				.getNumeroDeOcurrencias());
		this.roAccionVista.setRiesgoResidual(new BigDecimal(Double
				.toString(this.dataManagerSesion.getRiesgoResidual()))
				.setScale(2, 4));
		this.roAccionVista.setNumConsecResidual(Integer
				.toString(this.dataManagerSesion.getNumConsecResidual()));
		this.roAccionVista.setNumProbaResidual(this.dataManagerSesion
				.getNumProbaResidual());
		this.roAccionVista.setConsecResidual(this.dataManagerSesion
				.getConsecResidual());
		this.roAccionVista.setProbaResidual(this.dataManagerSesion
				.getProbaResidual());
		this.roAccionVista.setRiesgoInherente(new BigDecimal(Double
				.toString(this.dataManagerSesion.getRiesgoInherente()))
				.setScale(2, 4));
		this.roAccionVista.setNumConsecInherente(Integer
				.toString(this.dataManagerSesion.getNumConsecInherente()));
		this.roAccionVista.setNumProbaInherente(this.dataManagerSesion
				.getNumProbaInherente());
		this.roAccionVista.setConsecInherente(this.dataManagerSesion
				.getConsecInherente());
		this.roAccionVista.setProbaInherente(this.dataManagerSesion
				.getProbaInherente());
	}
	...
	public void guardarAccion() {
		try {
			this.roAccionVista
					.setRoResponsable((RoResponsable) this.servicioRoResponsable
							.buscarPorId(Integer
		...
		if (this.tipoGurdar) {
			...
			context.addMessage(null, new FacesMessage("Plan de Acción Añadido",
					"El Plan de Acción ha sido Añadido con Exito"));
			finalizarGuardado();
		}
	}
	...
	public void finalizarGuardado() {
		this.accionesTodos = this.servicioRoAccion
				.buscarRoAccionPorEventoFecha(
						this.roDetalleEventoVista.getCodigoDeve(), fechaInicio,
						fechaFin);
		cancelar();
	}

...
@ManagedBean
@ViewScoped
public class ControladorCrudRoAccionResponsable {
	@EJB
	...
	public static final String nombrePagina = "/paginas/CrudAccionResponsable.jsf";
	...
	public ControladorCrudRoAccionResponsable() {
	...
	public void seleccionar() {
		...
		this.roDetalleAccionTodos = this.servicioRoDetalleAccion
				.buscarRoDetalleAccionPorResponsableFecha(
						this.dataManagerSesion.getUsuarioSesion()
								.getCodigoUsua(), fechaInicio, fechaFin);
	...
	public void generarModelo() {
		...
		for (RoDetalleAccion item : roDetalleAccionTodos) {
			cal.set(item.getFechaInicioDeac().getYear() + 1900, item
					.getFechaInicioDeac().getMonth(), item.getFechaInicioDeac()
					.getDate());
			Date startReport = cal.getTime();
			cal.set(item.getFechaFinDeac().getYear() + 1900, item
					.getFechaFinDeac().getMonth(), item.getFechaFinDeac()
					.getDate());
			Date endReport = cal.getTime();
			model.add(new TimelineEvent(item.getNombreDeac(), startReport,
